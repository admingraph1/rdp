...
echo IP:
tasklist | find /i "ngrok.exe" >Nul && curl http://localhost:4040/api/tunnels | jq ".tunnels[0].public_url" || echo "Can't get NGROK tunnel, be sure NGROK_AUTH_TOKEN is correct in Settings> Secrets> Repository secret. Maybe your previous VM still running: https://dashboard.ngrok.com/status/tunnels " 
